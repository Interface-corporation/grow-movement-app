...
<div className="absolute inset-0 bg-gradient-to-t from-grow-navy/70 via-transparent to-grow-navy/20" />
      ...
      {/* Content */}
      <div className="relative z-10 h-full container mx-auto px-5 sm:px-6 lg:px-8 flex items-center pt-20">
      ...
      {/* Slide controls */}
      <div className="absolute bottom-8 left-0 right-0 z-20 container mx-auto px-5 sm:px-6 lg:px-8">
